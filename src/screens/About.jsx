    ...
    <>
      ...
      { tabView === 'Background' &&
        <div id="Background" className="content">
          ...
          <p className="p-with-indent">By the time I finished college, I had trouble finding a paying entry-level position - all the ones I'd found either wanted an unpaid intern or someone with several years working in a professional lab. Lacking the experience, I began searching for any position that would let me exercise what I learned, eventually finding a teaching position at a learning center.</p>
